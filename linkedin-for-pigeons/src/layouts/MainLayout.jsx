...
function MainLayout() {
  return (
    <div className="min-h-screen bg-li-bg">
      {/* Fixed top navbar */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white shadow-[0_0_0_1px_rgba(0,0,0,0.08),0_2px_3px_rgba(0,0,0,0.04)]">
      ...
      <main className="mx-auto max-w-[1128px] px-4 pt-[68px]">
        <Outlet />
      </main>
    </div>
  )
